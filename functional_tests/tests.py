...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def test_can_start_a_list_and_edit_it_later(self):
        ...
        # enters "Use peackcock feathers to make a fly"
        inputbox = self.browser.find_element_by_id('id_new_item')
        ...
        ## We use a new browser session to make sure that no information of Edith's is
        ## coming through from cookies, etc.
        self.browser.quit()
        self.browser = webdriver.Firefox()

        # Francis visists the homepage. There is no sign of Edith's list
        self.browser.get(self.live_server_url)
        ...
        # Satisified, the both go back to sleep
